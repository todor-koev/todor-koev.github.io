...
(2025). ["Bias in Tag Questions."](https://langsci-press.org/catalog/book/487) (with [Cory Bill](https://www.corybill.com/)) In T. Trinh et al. (eds.): *Biased Questions: Experimental Results and Theoretical Modelling*. Language Science Press, 145–178. [[preprint](/files/tag_questions__preprint_.pdf)]
...
(To appear). "Association with Contrastive Topic: Farsi *ke*." (with [Maryam Mohammadi](https://mohammadi-maryam.github.io/)) *Semantics And Linguistic Theory* 36.

(2025). ["Speaker Attitudes Predict Epistemic Biases in Polar Questions: Evidence from Farsi."](https://www.lingref.com/cpp/wccfl/42/paper3830.pdf) (with [Maryam Mohammadi](https://mohammadi-maryam.github.io/)) *West Coast Conference on Formal Linguistics* 42: 266-273, Cascadilla.  
